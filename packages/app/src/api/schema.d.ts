...
export interface paths {
    ...
    "/api/projects/{projectId}/files": {
        ...
        get: operations["list_project_files"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface operations {
    ...
    resume_turn: {
        ...
        requestBody?: never;
        responses: {
            /** @description SSE stream of agent events for the resumed turn */
            200: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description No provider/model recorded for the conversation */
            400: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Nothing to resume, or agent is already running */
            409: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    list_project_files: {
        parameters: {
            query?: {
                /** @description Directory path relative to the project working directory. Defaults to the root. */
                path?: string | null;
            };
            header?: never;
            path: {
        ...
        requestBody?: never;
        responses: {
            /** @description Directory entries (directories first, then alphabetical) */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    delete_provider: {
        ...
        responses: {
            ...
            /** @description Provider not found or is not deletable */
            404: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    delete_model: {
        ...
        responses: {
            ...
            /** @description Model not found or is not deletable */
            404: {
                headers: {
                    [name: string]: unknown;
                };
